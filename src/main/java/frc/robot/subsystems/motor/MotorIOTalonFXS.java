...
public class MotorIOTalonFXS implements MotorIO {

    private final TalonFXS talonfx;
    ...
    public MotorIOTalonFXS(int canid, CANBus canbus) {
        talonfx = new TalonFXS(canid, canbus);
